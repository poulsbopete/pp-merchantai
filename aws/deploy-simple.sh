...
# PayPal Merchant AI - Simplified AWS Deployment (No CloudFront)
set -e
...
STACK_NAME="${ENVIRONMENT}-pp-merchantai-simple"

echo "🚀 Deploying PayPal Merchant AI to AWS (Simplified - No CloudFront)"
...
# Deploy simplified CloudFormation stack (no CloudFront)
echo "☁️ Deploying simplified CloudFormation stack..."
aws cloudformation deploy \
    --template-file aws/cloudformation-simple.yml \
...
echo "✅ Simplified deployment completed successfully!"
echo ""
